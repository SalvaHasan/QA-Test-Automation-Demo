...
exports.FiverrDemo = class FiverrDemo{
  ...
  getElement(element){
    const elementDict ={
      ...
      PAGE_TITLE: 'h1.title',
      ALERT:'div.t-Alert.t-Alert--danger',

      // Buttons/Links
      LOGIN_BTN:'button.t-Button.t-Button--icon',
      OK_BTN:"button.t-Button.t-Button--hot",
  ...
  async login(userName,password) {
    ...
    await this.page.waitForSelector(this.getElement('ALERT'),{waitUntil:'visible'});
  }
  ...
  async clickOk(){
    await this.page.waitForSelector(this.getElement('ALERT'),{waitUntil:'visible'});
    await this.getElementLocator('OK_BTN').click();
